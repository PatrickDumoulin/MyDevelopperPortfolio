...
const About = () => {
  ...
  return (
    <div className="h-full bg-gradient-to-b from-[#0B1221] to-[#142237] py-32 text-center xl:text-left">
      <Circles />
      <motion.div
      ...
      <div className="container mx-auto h-full">
        {/* Ajout du conteneur scrollable pour mobile */}
        <div className="md:block h-[calc(100vh-200px)] md:h-auto overflow-y-auto md:overflow-visible custom-scrollbar">
          <div className="flex flex-col xl:flex-row gap-x-6">
            ...
            >
              ...
              {/* Zone scrollable pour les compétences (desktop et mobile) */}
